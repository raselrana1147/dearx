...
<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
    <div class="d-flex align-items-center me-3">
        <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Stories
...
@endsection
@section('content')
<a href="{{ route('story.create') }}" class="btn btn-success btn-sm" style="float: right;">Add</a>
		<div class="py-10">
			<div class="my-5">
